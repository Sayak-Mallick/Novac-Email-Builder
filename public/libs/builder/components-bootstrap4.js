...
// Vvveb.Components.add("html/footer", {
//     image: "icons/footer.svg",
//     nodes: ["footer"],
//     name: "Footer",
//     html: '   <div class="container">\
//         <footer class= "footer" >\
//             <p style="text-align:center">© Novac Technology Solution 2022</p>\
//       </footer>\
//     </div >'
// });
...
Vvveb.Components.add( "html/footer", {
    classes: ["footer"],
    name: "Footer",
    image: "icons/footer.png",
    html: '<div class="container">\
         <td><footer class="footer"><p style="text-align:center"> © <img src="https://www.novactech.in/favicon.ico" width="" height="15px" alt=""> Novac Technology Solution 2022</p></footer></td>\
    </div >'
});
